...
class phpSQL 
{
	...
	private $host=_eveHOST;
	private $port=_evePORT;
	private $user=_eveUSER;
	private $pass=_evePW;
	private $db=_eveDB;
	private $conn;
	private $sql;
	...
	private function close_conn()
	{
		...
		//commented out because it was causing problems with the ALE Eve API Lib's database connections (v0v)
