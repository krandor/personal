...
/*HTML Generation*
/*****************/
function startPage($css,$title="",$csspath="include/",$extra_head_info="") {
	...
	$text="<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\"><html><head>\n";
	...
	$text.=setCSS($css,$csspath);
	
	if($extra_head_info!="")
	{
		$text.=$extra_head_info;
	}
...
function startTableRow($id="", $class="")
{
	$text="<tr";
	if($name!="")
	{
...
function addTableCell($data,$colspan="", $id="", $class="")
{
	$text="<td";
	if($name!="")
	{
...
function buildTextarea($name, $cols="20", $rows="2", $text="") {
