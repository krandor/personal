...
class phpReportGenerator
{
	...
	function generateReport()
	{
		...
		*/
		...
		$html .= "<br /><b><u>".$this->title."</u></b>";
				
		//Check If our table has to be surrounded by an additional table
		//which increase style of this table
		if ($this->surrounded == true) {
			$html .= "<table width='$this->width'  border='1' cellspacing='0' cellpadding='0'><tr><td>\n";
		}
			
		$html .= "<table width='$this->modified_width'  border='$this->border' cellspacing='$this->cellspace' cellpadding='$this->cellpad'>\n";
		$html .= "<tr bgcolor = '$this->header_color'>\n";
		
		//Header Draw
		for ($i = 0; $i< $field_count; $i++)
		{
			//Now Draw Headers
			$html .= "<th align = '$this->header_alignment'><font color = '$this->header_textcolor'>&nbsp;".$this->fields[$i]."</font></th>\n";
		}
		...
		{
			$html .= "<tr align = '$this->body_alignment' bgcolor = '$this->body_color'>";
			for ($i = 0; $i < $field_count; $i++)
			{
				//Now Draw Data
				$html .= "<td><font color = '$this->body_textcolor'>&nbsp;".$rows[$i]."</font></td>";
			}
			$html .= "</tr>\n";
		}
		$html .= "</table>\n";
